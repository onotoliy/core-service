...
public class TreasureException extends TableImpl<TreasureExceptionRecord> {
     ...
     */
    public final TableField<TreasureExceptionRecord, UUID> GUID = createField(DSL.name("guid"), SQLDataType.UUID.nullable(false), this, "Уникальный идентификатор");

    /**
     * The column <code>public.treasure_exception.device</code>. Устройство
     */
    public final TableField<TreasureExceptionRecord, String> DEVICE = createField(DSL.name("device"), SQLDataType.VARCHAR, this, "Устройство");

    /**
     * The column <code>public.treasure_exception.agent</code>. Агент
     */
    public final TableField<TreasureExceptionRecord, String> AGENT = createField(DSL.name("agent"), SQLDataType.VARCHAR, this, "Агент");

    /**
     * The column <code>public.treasure_exception.message</code>. Сообщение об ошибки
     */
    public final TableField<TreasureExceptionRecord, String> MESSAGE = createField(DSL.name("message"), SQLDataType.VARCHAR, this, "Сообщение об ошибки");

    /**
     * The column <code>public.treasure_exception.localized_message</code>. Локализированое сообщение об ошибки
     */
    public final TableField<TreasureExceptionRecord, String> LOCALIZED_MESSAGE = createField(DSL.name("localized_message"), SQLDataType.VARCHAR, this, "Локализированое сообщение об ошибки");

    /**
     * The column <code>public.treasure_exception.stack_trace</code>. StackTrace
     */
    public final TableField<TreasureExceptionRecord, String> STACK_TRACE = createField(DSL.name("stack_trace"), SQLDataType.VARCHAR, this, "StackTrace");
